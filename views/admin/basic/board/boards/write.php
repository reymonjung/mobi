    ...
    <div class="box-table">
        ...
        ?>
            ...
            <div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">메인노출여부</label>
                    <div class="col-sm-8">
                        <label for="brd_main_exposure" class="checkbox-inline">
                            <input type="checkbox" name="brd_main_exposure" id="brd_main_exposure" value="1" <?php echo set_checkbox('brd_main_exposure', '1', (element('brd_main_exposure', element('data', $view)) ? true : false)); ?> /> 사용합니다
                        </label>
                    </div>
                </div>
