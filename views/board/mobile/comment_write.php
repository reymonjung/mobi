    ...
    <div id="comment_write_box">
        <div class="well comment_write_box_inner ">
            ...
            ?>
                ...
                <input type="hidden" id="cmt_nickname" name="cmt_nickname" value="<?php echo set_value('cmt_nickname') ? set_value('cmt_nickname') : '손님'; ?>" />
                <?php
                ...
                ?>                
                <input class="input  reply01" name="cmt_content" id="cmt_content"   accesskey="c" <?php if ( ! element('can_comment_write', element('comment', $view))) {echo 'onClick="alert(\'' . html_escape(element('can_comment_write_message', element('comment', $view))) . '\');return false;"';} ?>><?php echo set_value('cmt_content', element('cmt_content', element('comment', $view))); ?>
                ...
                <?php } ?>
                    ...
                    <div class="submit02">
                    <input type="button" id="cmt_btn_submit" onClick="<?php if ( ! element('can_comment_write', element('comment', $view))) {echo 'alert(\'' . html_escape(element('can_comment_write_message', element('comment', $view))) . '\');return false;"';} else { ?>add_comment(this.form, '<?php echo element('post_id', element('post', $view)); ?>');<?php } ?> " value="등 록">
                    </div>
                   
                 <div class="comment_write_button_area hide">
