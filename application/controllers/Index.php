...
class Index extends CB_Controller
{
    ...
    {   
        ...
        $layoutconfig = array(
            ...
            'use_sidebar' => $this->cbconfig->item('sidebar_index'),
            'use_mobile_sidebar' => $this->cbconfig->item('mobile_sidebar_index'),
            'skin_dir' => $this->cbconfig->item('skin_index'),
            'mobile_skin_dir' => $this->cbconfig->item('mobile_skin_index'),
