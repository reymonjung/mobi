...
class Boards extends CB_Controller
{
    ...
    public function write($pid = 0)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $brd_main_exposure = $this->input->post('brd_main_exposure') ? $this->input->post('brd_main_exposure') : 0;
            $updatedata = array(
                ...
                'brd_main_exposure' => $brd_main_exposure,
            );
    ...
    public function listupdate()
    {
        ...
        if ($this->input->post('chk') && is_array($this->input->post('chk'))) {
            ...
            $brd_main_exposure = $this->input->post('brd_main_exposure');
            ...
            foreach ($this->input->post('chk') as $val) {
                if ($val) {
                    ...
                    $brd_main_exposure_update = element($val, $brd_main_exposure) ? 1 : 0;
                    ...
                    $updatedata = array(
                        ...
                        'brd_main_exposure' => $brd_main_exposure_update,
                    );
                    $metadata = array(
